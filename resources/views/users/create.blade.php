...
@section('content')
    <div>
        ...
        <form action="{{ route('users.store') }}">
            ...
            <input type="password" name="password" id="password" value="{{ old('password') }}" placeholder="***************" style="text-align: center;"><br><br>

            <input type="submit" value="Criar"> - <a href="{{ route('users.index') }}">Listar</a>
